...
#SBATCH --output=/ukp-storage-1/kuczykowska/code/SLED/metric_test_daic_regression.log
...
--output_dir /ukp-storage-1/kuczykowska/code/SLED/tmp/metric_daic_regression \
--learning_rate 2e-5 \
