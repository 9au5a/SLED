...
#SBATCH --output=/ukp-storage-1/kuczykowska/code/SLED/T12_daic_evaluate.log
...
python3.9 /ukp-storage-1/kuczykowska/code/SLED/examples/seq2seq/evaluate_binary_daic.py