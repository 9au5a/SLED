...
#SBATCH --output=/ukp-storage-1/kuczykowska/code/SLED/daic_classification_binary.log
...
--output_dir /ukp-storage-1/kuczykowska/code/SLED/tmp/daic_classification_binary_new_labels \
--learning_rate 2e-5 \
